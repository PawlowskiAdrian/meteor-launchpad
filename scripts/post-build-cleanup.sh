...
apt-get purge -y --auto-remove apt-transport-https gpg gpg-agent build-essential dirmngr libarchive-tools bzip2 ca-certificates curl git python python3 chrpath apt-utils
